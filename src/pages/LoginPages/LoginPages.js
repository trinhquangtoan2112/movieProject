...
export default function LoginPages(props) {
  ...
  return (
    <div className=' '>
    <div className=' md:w-12/12 md:flex md:justify-center'>    <form onSubmit={formik.handleSubmit} className="md:w-4/5 md:flex md:justify-center md:items-center  flex-col">
