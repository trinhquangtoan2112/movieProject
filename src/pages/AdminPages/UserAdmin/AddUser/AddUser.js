...
import { ThemNguoiDUngTuAdmin, getMaLoai } from '../../../../redux/action/QuanLyNguoiDungAction';
export default function AddUser() {
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            ...
            setTimeout(() => {
                if (disabled === true) {
                    dispatch(ThemNguoiDUngTuAdmin(values))
                } else {
                            ...
                            <div>
                                ...
                                <div className="mt-8">
                                    ...
                                    <div className="flex justify-between items-center">
                                        ...
                                        <Select defaultValue={maLoaiNguoiDung[0]?.maLoaiNguoiDung} placeholder={maLoaiNguoiDung[0]?.tenLoai} style={{ width: "80%", }} options={renderOption()} onChange={(value)=>{
